    ...
    <div style="margin: auto">
        <form action="/MyMenu" method="post">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="textbox" name="name" value="{{$foods->name}}"/>
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="description">{{$foods->description}}</textarea>
            </div><br>
            <div class="form-group">
                <label class="control-label">Calorie Count</label>
                <input type="textbox" name="calorieCount" value="{{$foods->calorieCount}}"/>
            </div><br>
            <div class="form-group">
                <label  class="control-label">Price</label>
                <input type="textbox" name="price" value="{{$foods->price}}"/>
            </div><br>
            <div class="form-group form-check">
                <label class="form-check-label">Plat du jour?</label>
                <select name="platDuJour">
                    @if($foods->isPlatDuJour == 1)
                    <option value="1" selected>Yes</option>
                    <option value="0">No</option>
                    @endif
                    @if($foods->isPlatDuJour == 0)
            ...
            <div class="form-group">
                ...
                <input type="textbox" name="offer" value="{{$foods->offer}}"/>
            </div><br>
            <div class="form-group">
                <label asp-for="idCategory" class="control-label">Category</label>
                <select name="category">
                    @foreach($categories as $category)
                        @if($foods->idCategory == $category->id)
