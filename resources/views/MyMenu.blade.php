...
<p>
        ...
        @csrf
          ...
          <div class="button-wrap"> 
                  <button class="button button-xs button-secondary button-winona">Create Food</button>
          </div>        
          </form>
</p>
<table class="table">
    ...
    @foreach($food as $foods)
        <tr>
            ...
            <td>
            <img src="../images/{{$foods->image}}" alt="" style="width:50px; height:50px"/>
            </td>
            <td>
            {{$foods->description}}
            </td>
            ...
            @if($categories->id == $foods->idCategory)
            {{$categories->name}}
            @endif
            @endforeach
            </td>
